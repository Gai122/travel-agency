...
const AllUsers = ({loaderData}: Route.ComponentProps) => {
    ...
    return (
        <main className="all-users wrapper">
            <Header
                title="Manage Users"
                description="Filter, sort, and aaccess detailed user profiles"
            />
                ...
                <ColumnsDirective>
                    ...
                    <ColumnDirective
                        ...
                        template={({status}: UserData) => (
                            ...
                            ('status-column', status === 'user' ? 'bg-success-50' : 'bg-light-300')}>
                                <div className={cn('1.5 rounded-full', status === 'user' ? 'bg-success-500' :
                                    'bg-gray-500')}/>
